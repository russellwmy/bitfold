...
//!
//! This crate provides optional convenience utilities for working with Bitfold:
//!
//! ## Address Utilities
...
/// # Examples
/// ```no_run
/// use bitfold_utilities::reverse_lookup;
...
/// # Examples
/// ```
/// use bitfold_utilities::parse_ip;
///
...
/// # Examples
/// ```
/// use bitfold_utilities::format_ip;
...
/// # Examples
/// ```
/// use bitfold_utilities::format_ip_addr;
/// use std::net::{IpAddr, Ipv4Addr};
///
