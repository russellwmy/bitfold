//! Simple client that sends messages to a Bitfold server and prints replies.
//!
...
//! - cargo run --example client -- 127.0.0.1:7777 10 200
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Bitfold client bound to {} -> sending {} messages to {} (every {}ms)",
