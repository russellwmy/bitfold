...
//! - `protocol`: command codec, congestion control, bandwidth management, channels
//! - `peer`: command queue for session batching
//! - `host`: connection management, throughput monitoring
