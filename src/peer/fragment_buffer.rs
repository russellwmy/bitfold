...
//! in the Bitfold networking protocol. Large packets that exceed the maximum transmission unit
...
/// ```
pub fn cleanup_stale_fragments(
    command_fragments: &mut HashMap<u16, CommandFragmentBuffer>,
    time: Instant,
) {
