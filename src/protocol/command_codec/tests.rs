...
mod tests {
    ...
    use crate::{
        core::shared::SharedBytes,
        protocol::command::{CommandPacket, ProtocolCommand},
    };
    ...
    fn test_encode_decode_packet() {
        ...
        packet.add_command(ProtocolCommand::SendUnreliable {
            channel_id: 0,
            data: SharedBytes::from_vec(vec![5, 6, 7]),
        });
